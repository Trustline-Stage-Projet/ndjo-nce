...
export interface MethodePayement {
  id?: number;
  payement_abord: boolean;
  payement_virement: boolean;
  payement_paypal: boolean;
  payement_stripe: boolean;
  payment_en_compte: boolean;
  createdAt?: Date;
}
